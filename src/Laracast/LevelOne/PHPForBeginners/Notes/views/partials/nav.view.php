<nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <a href="/Laracast/LevelOne/PHPForBeginners/Notes/" aria-current="page" class="<?= urlIs('/Laracast/LevelOne/PHPForBeginners/Notes/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Dashboard</a>
                <a href="/Laracast/LevelOne/PHPForBeginners/Notes/about/" class="<?= urlIs('/Laracast/LevelOne/PHPForBeginners/Notes/about/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">About</a>
                <a href="/Laracast/LevelOne/PHPForBeginners/Notes/notes/" class="<?= urlIs('/Laracast/LevelOne/PHPForBeginners/Notes/notes/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Note</a>
                <a href="/Laracast/LevelOne/PHPForBeginners/Notes/contact/" class="<?= urlIs('/Laracast/LevelOne/PHPForBeginners/Notes/contact/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Contact</a>
                </div>
            </div>
            </div>
            <div class="hidden md:block">
